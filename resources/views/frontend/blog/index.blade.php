                        ...
                        <div class="post-list-content">
                            ...
                            <ul class="entry-meta">
                                <li class="post-author-img">
                                    @if ($blog->RelationWithUser->user_photo == 'default.jpg')
                                    <img src="{{ asset('user_default_picture') }}/{{ $blog->RelationWithUser->user_photo }}" alt="">
                                    @else
                                        <img src="{{ asset('profile_image_user') }}/{{ $blog->RelationWithUser->user_photo }}" alt="">
                                    @endif
                                </li>
